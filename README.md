...
Objectives
Predict current solar AC power generation.
Forecast future AC power using weather parameters.
Improve forecasting accuracy using lag-based time-series features.
Compare multiple machine learning algorithms.
Develop interactive Tableau dashboards for visualization and analysis.
...
Time-series power generation records
Features Used
Plant ID
Inverter ID
Irradiation
